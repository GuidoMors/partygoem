...
function redirectPage(){
	...
	if(gameId==0){ // users should always have a gameId; admin should either come from login page and be redirected to lobby, or be already in the lobby
		if (currentPage=="login"){	
			window.location.href = "/";
		}
		else if (currentPage=="" || currentPage=="/"){
			// do nothing; already here: window.location.href = "/";
		}
		else{	
			redirectTo404();
		}
